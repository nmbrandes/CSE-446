...
This is the base repository for CSE 446 homeworks. To save disk space and keep your environment consistent, we recommend a structure where all homeworks share a single virtual environment located in your `hw0` or root directory.
...
To allow your IDE (like VSCode) to find your Python interpreter when you open the top-level cse446-coding folder, create a symbolic link:
